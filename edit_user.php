...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_user') {
    if ($auth->validateCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        $result = $userCRUD->updateUser($user_id, $user_update, $profile_update);
...
<head>
    ...
    <title>Edit User - Secure User Management System</title>
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-edit me-2"></i>Edit User: <?php echo Auth::sanitizeOutput($user_data['full_name']); ?>
                        </h4>
                    </div>
                    <div class="card-body">
                        <?php if ($error): ?>
                        ...
                        <form method="POST" action="" id="editUserForm">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" 
                                           value="<?php echo Auth::sanitizeOutput($user_data['username']); ?>" disabled>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" 
                                           value="<?php echo date('M j, Y', strtotime($user_data['created_at'])); ?>" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <h5 class="border-bottom pb-2 mb-3">
                                        <i class="fas fa-id-card me-2 text-success"></i>Profile Information
                                    </h5>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" id="address" name="address" rows="3"
                                              placeholder="Enter address"><?php echo Auth::sanitizeOutput($user_data['address'] ?? ''); ?></textarea>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="bio" name="bio" rows="4" 
                                              ...
                                              maxlength="500"><?php echo Auth::sanitizeOutput($user_data['bio'] ?? ''); ?></textarea>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-md-3">
                                <div class="bg-warning text-white rounded p-3">
                                    ...
                                    <h6>Role</h6>
                                    <small><?php echo ucfirst($user_data['role']); ?></small>
                                </div>
                            </div>
                        </div>
                    </div>
